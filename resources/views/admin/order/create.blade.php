        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="simpleinput" name="user_id" class="form-control" required>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="simpleinput" name="address" class="form-control" required>
                <div class="invalid-feedback"> Please choose a name. </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input class="form-control floatInput" id="custom-money" type="text" name="total" required>
