...
<div class="card shadow mb-4">
    <div class="card-header">
        <h4>
            <strong class="card-title">Edit color</strong>
        </h4>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <select class="form-control select2" name="product_id" id="simple-select2">
                    ...
                    @if ($img->product_id == $item['id'])
                        <option value="{{ $item['id'] }}" selected>({{ $item['product_code'] }}) {{ $item['name'] }}</option>
                    @endif
            ...
            <div class="form-group mb-3">
                ...
                <div class="custom-file">
                  <input type="file" class="custom-file-input" value="{{ $img->image }}" name="image" id="imgInp">
                  <label class="custom-file-label" id="choose-file-value" for="customFile">Choose file</label>
                </div>
                <br>
                <img width="160px" id="blah" src="{{ url('public/upload').'/'.$img->image }}" style="display: none; margin-top: 10px" alt="your image" />
              </div>
