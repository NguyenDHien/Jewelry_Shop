...
@section('body')
        ...
        <a class="btn mb-2 btn-success" href="{{ route('admin.product.create') }}" style="color: black">Create<span class="fe fe-plus fe-15 ml-2"></span></a>
                ...
                <table class="table table-hover datatables" id="dataTable-1">
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        @endif
                        <td><textarea class="overflow-auto cus-scroll-bar" disabled >{{ $item['description'] }}</textarea></td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1">
                              <a class="dropdown-item" href="{{ route('admin.product.edit', [$id = $item['id']]) }}">Edit</a>
                              <a class="dropdown-item" href="{{ route('admin.product.delete', [$id = $item['id']]) }}">Remove</a>
                            </div>
                          </div>
                        </td>
                      </tr>
